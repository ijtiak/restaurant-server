...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.z3hgdna.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.listen(port, () => {
  console.log(`server is playing on ${port}`);
})